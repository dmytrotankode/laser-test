...
Originally built on the `3d-pose-fit` branch (see 3D_POSE_FIT_STATUS.md
there) for the honest 3D pose-fit experiment; ported back to `main`
unchanged to support a physically-grounded lever-arm correction in
step04_fit_masks.py/step06_fit_3d.py (see lever_arm_correction.py).
"""
import numpy as np
import cv2
