...
def main():
    ...
    results = {
        ...
        "caption": warn + f"Силует виділено нейромережевим сегментатором ({backend}). Автоматично відсічено вертикальну монтажну стійку; лінію Cutoff встановлено на 58% висоти купола від верхівки, щоб нерівний необрізаний кевлар унизу не потрапляв у розрахунок. Далі використовується лише верхня частина силуету."
    }
