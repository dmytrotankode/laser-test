...
l e t   a u t o R u n I n t e r v a l   =   n u l l ; 
 
 a s y n c   f u n c t i o n   s t a r t A u t o R u n ( )   { 
         i f   ( a u t o R u n I n t e r v a l )   c l e a r I n t e r v a l ( a u t o R u n I n t e r v a l ) ; 
         
         / /   D i s a b l e   a u t o   r u n   b u t t o n 
         c o n s t   a u t o B t n   =   d o c u m e n t . g e t E l e m e n t B y I d ( ' b t n - a u t o - r u n ' ) ; 
         i f   ( a u t o B t n )   a u t o B t n . i n n e r T e x t   =   ' 2B>. . . ' ; 
         
         c o n s t   r u n N e x t   =   a s y n c   ( )   = >   { 
                 i f   ( ! c u r r e n t S e s s i o n I d )   { 
                         a w a i t   s t a r t S e s s i o n ( ) ; 
                 } 
                 
                 / /   A r e   a n y   s t e p s   c u r r e n t l y   r u n n i n g ? 
                 c o n s t   i s R u n n i n g   =   [ 1 , 2 , 3 , 4 , 5 , 6 , 7 ] . s o m e ( i   = >   { 
                         c o n s t   b t n   =   d o c u m e n t . g e t E l e m e n t B y I d ( i   <   3   ?   ' b t n - r u n - 0 '   +   i   :   ' b t n - s t e p 0 '   +   i ) ; 
                         r e t u r n   b t n   & &   b t n . i n n e r T e x t . i n c l u d e s ( ' 1@>1:0' ) ; 
                 } ) ; 
                 
                 i f   ( i s R u n n i n g )   r e t u r n ;   / /   W a i t   f o r   c u r r e n t   s t e p   t o   f i n i s h 
                 
                 / /   F i n d   n e x t   s t e p   t o   r u n 
                 f o r   ( l e t   i   =   1 ;   i   < =   7 ;   i + + )   { 
                         c o n s t   b t n   =   d o c u m e n t . g e t E l e m e n t B y I d ( i   <   3   ?   ' b t n - r u n - 0 '   +   i   :   ' b t n - s t e p 0 '   +   i ) ; 
                         i f   ( b t n   & &   ! b t n . d i s a b l e d   & &   b t n . i n n e r T e x t . i n c l u d e s ( ' 8:>=0B8' ) )   { 
                                 b t n . c l i c k ( ) ; 
                                 r e t u r n ; 
                         } 
                 } 
                 
                 / /   C h e c k   i f   a l l   d o n e 
                 c o n s t   a l l D o n e   =   [ 1 , 2 , 3 , 4 , 5 , 6 , 7 ] . e v e r y ( i   = >   { 
                         c o n s t   b t n   =   d o c u m e n t . g e t E l e m e n t B y I d ( i   <   3   ?   ' b t n - r u n - 0 '   +   i   :   ' b t n - s t e p 0 '   +   i ) ; 
                         r e t u r n   b t n   & &   ( b t n . i n n e r T e x t . i n c l u d e s ( ' 8:>=0=>' )   | |   b t n . i n n e r T e x t . i n c l u d e s ( ' >B>2>' ) ) ; 
                 } ) ; 
                 
                 i f   ( a l l D o n e )   { 
                         c l e a r I n t e r v a l ( a u t o R u n I n t e r v a l ) ; 
                         a u t o R u n I n t e r v a l   =   n u l l ; 
                         i f   ( a u t o B t n )   a u t o B t n . i n n e r T e x t   =   ' 0?CA:  A5AA88  ( 2B>) ' ; 
                         c o n s o l e . l o g ( ' 2B>- 28:>=0==O  7025@H5=>! ' ) ; 
                 } 
         } ; 
         
         a u t o R u n I n t e r v a l   =   s e t I n t e r v a l ( r u n N e x t ,   2 0 0 0 ) ; 
         r u n N e x t ( ) ; 
 }  
 